...
import { UserPlus, Shield, Radio, Bot, Activity, Lock, Mail, User } from 'lucide-react';
      ...
      >
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          <div className={`input-group auth-input-group ${focusedField === 'name' ? 'focused' : ''}`}>
            ...
            <input className="input" placeholder="Your full name" onFocus={() => setFocusedField('name')} onBlur={() => setFocusedField(null)} />
          </div>
          ...
          <div className={`input-group auth-input-group ${focusedField === 'email' ? 'focused' : ''}`}>
            ...
            <input className="input" type="email" placeholder="you@company.com" onFocus={() => setFocusedField('email')} onBlur={() => setFocusedField(null)} />
          </div>
          ...
          <div className={`input-group auth-input-group ${focusedField === 'password' ? 'focused' : ''}`}>
            ...
            <input className="input" type="password" placeholder="Min. 8 characters" onFocus={() => setFocusedField('password')} onBlur={() => setFocusedField(null)} />
          </div>
